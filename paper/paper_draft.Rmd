...
* why was migration lost on the islands
* have the map figure here
* why does diapause matter
...
```{r Figure_1_print,echo=FALSE,warning=FALSE,fig.cap="Figure 1: Principal Component Analysis of the monarchs from 2016 and 2018, colored by maternal family.",fig.width=8, fig.height=8, fig.align='center', fig.cap.style="Image Caption"}
